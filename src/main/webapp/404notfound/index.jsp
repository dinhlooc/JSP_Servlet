        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    ...
                    <a class="btn-backtohome btn bsb-btn-5xl btn-dark rounded-pill px-5 fs-6 m-0" href="../Home" role="button" style="background: linear-gradient(to right, #ef3e0f, #ffb800); border-color: #fff">Back to Home</a>
                </div>
            </div>
        </div>
    </div>
